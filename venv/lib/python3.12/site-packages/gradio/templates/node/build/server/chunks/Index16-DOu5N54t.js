...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-DMesThp_.js';
...
const lang_map = {
  python: () => import('./index33-Dd9wx8oM.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-BxaEuZI7.js'),
      import('./frontmatter-x1ohMjZ7.js')
    ]);
  ...
  json: () => import('./index38-uUSt376s.js').then((m) => m.json()),
  html: () => import('./index35-DrQfkOSx.js').then((m) => m.html()),
  css: () => import('./index36-DhjFdpji.js').then((m) => m.css()),
  javascript: () => import('./index37-DXnQRPUB.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-DXnQRPUB.js').then(
...
//# sourceMappingURL=Index16-DOu5N54t.js.map
