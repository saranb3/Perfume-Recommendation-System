...
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, P as Undo, u as Download } from './2-DMesThp_.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-BnkhCn3g.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-s8HdIRjs.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-BcwUeFNA.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-DR5YXxvC.js.map
